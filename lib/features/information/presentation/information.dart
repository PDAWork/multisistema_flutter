...
import 'package:multisitema_flutter/app/features/information/presentation/pages/page_one.dart';
                    ...
                    return Row(
                      children: [
                        Expanded(
                          flex: 2,
                          child: TextButton(
                            onPressed: () => context.go(Pages.splashScreen.screenPath),
                        ...
                        Expanded(
                          ...
                          child: TextButton(
                            onPressed: () {
                              if (value.index == 2) {
                                context.go(Pages.splashScreen.screenPath);
                              }
